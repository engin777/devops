...
pipeline {
    agent any
    environment {
        ECR_REGISTRY = "788593813936.dkr.ecr.us-east-1.amazonaws.com"
...
```bash
docker run --name todo -dp 80:3000 788593813936.dkr.ecr.us-east-1.amazonaws.com/clarusway/to-do-app:latest
```
...
```json
{
	...
	"containerDefinitions": [{
		"name": "to-do-app",
		"image": "788593813936.dkr.ecr.us-east-1.amazonaws.com/clarusway/to-do-app:latest",
		"portMappings": [{
			"containerPort": 3000,
			"protocol": "tcp"
		}],
	...
	"cpu": "256",
	"memory": "512",
        "executionRoleArn": "arn:aws:iam::788593813936:role/ecsTaskExecutionRole"
}
```
